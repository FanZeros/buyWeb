...
const shopItems = [
    ...
    { series: "dungeon", name: "地牢探险者时长卡", desc: "灵魂获得×2 + 每日12碎片，薛定谔迷宫离线收益翻倍", price: "", redeemable: true, subItems: [
        ...
        { name: "永久卡", desc: "10000碎片 + 永久时长", price: 125 },
    ...
    { series: "dungeon", name: "永久自选/定制装备", desc: "额外自选技能装备个数，通关后可用，可多次叠加", price: "", redeemable: true, subItems: [
        { name: "永久自选+1", desc: "额外+1个", price: 14.44 },
        { name: "永久自选+4", desc: "额外+4个", price: 55.55 },
        { name: "永久自选+10", desc: "额外+10个", price: 133.32 },
        { name: "购买定制装备", desc: "无需消耗自选点数，一键兑换", price: "60起" },
    ], link: "http://zeros.group/dz.xlsx" },

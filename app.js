...
const shopItems = [
    ...
    { series: "dungeon", name: "地牢探险者周卡【7天】", desc: "80地牢碎片 + 7日探险者时长，灵魂×2 + 每日12碎片", price: 7.20, redeemable: true, details: "立刻获得80地牢碎片 + 7日「地牢探险者」时长\n「地牢探险者」生效期间：灵魂获得×2（与其他倍率累乘）+ 每日12碎片\n薛定谔迷宫：离线收益2倍 & 最长从2h→24h\n多次购买总时长相加，每日奖励不叠加" },
    { series: "dungeon", name: "地牢探险者月卡【30天】", desc: "360地牢碎片 + 30日探险者时长，灵魂×2 + 每日12碎片", price: 25, redeemable: true, details: "立刻获得360地牢碎片 + 30日「地牢探险者」时长\n「地牢探险者」生效期间：灵魂获得×2（与其他倍率累乘）+ 每日12碎片\n薛定谔迷宫：离线收益2倍 & 最长从2h→24h\n多次购买总时长相加，每日奖励不叠加" },
    { series: "dungeon", name: "地牢探险者永久卡", desc: "10000地牢碎片 + 永久探险者，灵魂×2 + 每日12碎片", price: 125, redeemable: true, details: "立刻获得10000地牢碎片 + 永久「地牢探险者」时长\n「地牢探险者」生效期间：灵魂获得×2（与其他倍率累乘）+ 每日12碎片\n薛定谔迷宫：离线收益2倍 & 最长从2h→24h" },
    ...
    { series: "dungeon", name: "永久自选+1", desc: "额外自选技能/装备+1个，通关后可用，可多次叠加", price: 14.44, redeemable: true },
    { series: "dungeon", name: "永久自选+4", desc: "额外自选技能/装备+4个，通关后可用，可多次叠加", price: 55.55, redeemable: true },
    { series: "dungeon", name: "永久自选+10", desc: "额外自选技能/装备+10个，通关后可用，可多次叠加", price: 133.32, redeemable: true },

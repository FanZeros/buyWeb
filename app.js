...
const shopItems = [
    ...
    { series: "dungeon", name: "地牢探险者时长卡", desc: "灵魂获得×2 + 每日12碎片，薛定谔迷宫离线收益翻倍", price: "7.2起", redeemable: true, details: "周卡【7天】… ♥ 7.2（80碎片 + 7日时长）\n月卡【30天】… ♥ 25（360碎片 + 30日时长）\n永久卡 ………… ♥ 125（10000碎片 + 永久时长）\n\n「地牢探险者」生效期间：\n· 灵魂获得×2（与其他倍率累乘）\n· 每日获得12×地牢碎片\n· 薛定谔迷宫：离线收益2倍 & 最长时长从2h→24h\n\n多次购买时总时长相加，每日奖励不叠加" },
    ...
    { series: "dungeon", name: "永久自选机会", desc: "额外自选技能/装备个数，通关后可用，可多次叠加购买", price: "14.44起", redeemable: true, details: "永久自选+1 ……♥ 14.44\n永久自选+4 ……♥ 55.55\n永久自选+10 …♥ 133.32\n\n通关一次后即可使用，可购买多次叠加个数" },
